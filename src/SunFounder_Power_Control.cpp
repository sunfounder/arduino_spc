...
#include "SunFounder_Power_Control.h"

SunFounder_Power_Control::SunFounder_Power_Control() {}

int8_t SunFounder_Power_Control::begin() {
  uint8_t address = 0;
...
uint16_t SunFounder_Power_Control::readInputVoltage() {
...
int16_t SunFounder_Power_Control::readInputCurrent() {
...
uint16_t SunFounder_Power_Control::readOutputVoltage() {
...
int16_t SunFounder_Power_Control::readOutputCurrent() {
...
uint16_t SunFounder_Power_Control::readBatteryVoltage() {
...
int16_t SunFounder_Power_Control::readBatteryCurrent() {
...
uint8_t SunFounder_Power_Control::readBatteryPercentage() {
...
uint16_t SunFounder_Power_Control::readBatteryCapacity() {
...
uint8_t SunFounder_Power_Control::readPowerSource() {
...
bool SunFounder_Power_Control::readIsInputPluggedIn() {
...
bool SunFounder_Power_Control::readIsBatteryPluggedIn() {
  if (!this->device.peripherals.is_plugged_in)  {
...
bool SunFounder_Power_Control::readIsCharging() {
...
uint8_t SunFounder_Power_Control::readFanPower() {
...
uint8_t SunFounder_Power_Control::readShutdownRequest() {
...
uint8_t SunFounder_Power_Control::readShutdownBatteryPercentage() {
...
bool SunFounder_Power_Control::readIsAlwaysOn() {
...
uint8_t SunFounder_Power_Control::readBoardId() { return i2c.readU8(REG_READ_BOARD_ID); }

uint16_t SunFounder_Power_Control::readPowerSourceVoltage() {
...
void SunFounder_Power_Control::writeFanPower(uint8_t power) {
  if (!this->device.peripherals.fan_power) {
...
void SunFounder_Power_Control::writeShutdownBatteryPercentage(uint8_t percentage) {
  if (!this->device.peripherals.shutdown_battery_percentage) {
...
void SunFounder_Power_Control::readAll() {
...
String SunFounder_Power_Control::readFirmwareVersion() {
