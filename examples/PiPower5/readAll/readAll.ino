...
{
  Serial.begin(9600);
  Serial.println(F("PiPower 5 Read All"));
  Wire.begin();
...
void loop()
{
  ...
  Serial.print(F(" - "));
  Serial.println(spc.powerSource == POWER_SOURCE_EXTERNAL ? "External" : "Battery");
